...
const CreateBusThirdPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-row justify-between">
        ...
        <div>
          <button className="btn flex-1 btn-outline rounded-[12px] bg-white hover:bg-white hover:text-black text-sm">
            <CancelIcon />
            Cancelar
          </button>
        </div>
      ...
      <div className="flex justify-between mb-10">
        ...
        <div className="flex gap-4">
          <Link
            ...
            href="/bus/create/second-step">
            Atrás
          </Link>

          <Link
            href="/bus/create/fourth-step"
...
export default CreateBusThirdPage;
