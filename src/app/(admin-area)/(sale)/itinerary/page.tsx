...
import TableItineraries from '../../ticket-sales/itinerary/components/table';
import {useRouter} from 'next/navigation';
import TableItinerariesIda from '../../ticket-sales/itinerary/components/tableida';
          ...
          <div className="flex">
            <div className="grow flex items-center">
              ...
              <div className="">
                ...
                <div className="text-xl text-primary">TRUJILLO - LIMA</div>
              </div>
            </div>
